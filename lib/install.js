...
async function giveWorldPrivileges() {
  ...
  await privileges.categories.give(defaultPrivileges.slice(2), -1, ['fediverse']);
...
async function enableDefaultPlugins() {
  ...
  let defaultEnabled = ['nodebb-plugin-composer-default', 'nodebb-plugin-dbsearch', 'nodebb-plugin-markdown', 'nodebb-plugin-mentions', 'nodebb-plugin-web-push', 'nodebb-widget-essentials', 'nodebb-rewards-essentials', 'nodebb-plugin-emoji', 'nodebb-plugin-emoji-android'];
...
install.giveWorldPrivileges = giveWorldPrivileges;