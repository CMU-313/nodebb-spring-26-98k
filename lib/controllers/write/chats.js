...
Chats.toggleTyping = async (req, res) => {
  ...
  await api.chats.toggleTyping(req, {
    typing,
    ...req.params
  });
  helpers.formatApiResponse(200, res);
...
Chats.toggleOwner = async (req, res) => {
  ...
  await api.chats.toggleOwner(req, {
    state,
    ...req.params
  });
  helpers.formatApiResponse(200, res);
...
Chats.messages.list = async (req, res) => {
  ...
  const {
    messages
  } = await api.chats.listMessages(req, {
    uid,
    roomId,
    start,
    direction
...
Chats.messages.getPinned = async (req, res) => {
  ...
  helpers.formatApiResponse(200, res, await api.chats.getPinnedMessages(req, {
    start,
    ...req.params
  }));
};
Chats.messages.get = async (req, res) => {
  ...
  helpers.formatApiResponse(200, res, await api.chats.getMessage(req, {
    mid,
    roomId
  }));
};
Chats.messages.getRaw = async (req, res) => {
  helpers.formatApiResponse(200, res, await api.chats.getRawMessage(req, {
    ...req.params
  }));
};
Chats.messages.getIpAddress = async (req, res) => {
  helpers.formatApiResponse(200, res, await api.chats.getIpAddress(req, {
    ...req.params
  }));
};
...
Chats.messages.delete = async (req, res) => {
  ...
  await api.chats.deleteMessage(req, {
    mid
  });
  helpers.formatApiResponse(200, res);
};
Chats.messages.restore = async (req, res) => {
  ...
  await api.chats.restoreMessage(req, {
    mid
  });
  helpers.formatApiResponse(200, res);
};
