...
Topics.delete = async (req, res) => {
  await api.topics.delete(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.restore = async (req, res) => {
  await api.topics.restore(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.purge = async (req, res) => {
  await api.topics.purge(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
...
Topics.unpin = async (req, res) => {
  await api.topics.unpin(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.endorse = async (req, res) => {
  await api.topics.endorse(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.unendorse = async (req, res) => {
  await api.topics.unendorse(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.lock = async (req, res) => {
  await api.topics.lock(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
Topics.unlock = async (req, res) => {
  await api.topics.unlock(req, {
    tids: [req.params.tid]
  });
  helpers.formatApiResponse(200, res);
};
...
Topics.deleteTags = async (req, res) => {
  await api.topics.deleteTags(req, {
    tid: req.params.tid
  });
  helpers.formatApiResponse(200, res);
};
Topics.getThumbs = async (req, res) => {
  ...
  helpers.formatApiResponse(200, res, await api.topics.getThumbs(req, {
    ...req.params,
    thumbsOnly
  }));
};
Topics.addThumb = async (req, res) => {
  ...
  const files = await uploadsController.uploadThumb(req, res);
...
Topics.getEvents = async (req, res) => {
  const events = await api.topics.getEvents(req, {
    ...req.params
  });
  helpers.formatApiResponse(200, res, {
    events
...
Topics.deleteEvent = async (req, res) => {
  await api.topics.deleteEvent(req, {
    ...req.params
  });
  helpers.formatApiResponse(200, res);
};
Topics.markRead = async (req, res) => {
  await api.topics.markRead(req, {
    ...req.params
  });
  helpers.formatApiResponse(200, res);
};
Topics.markUnread = async (req, res) => {
  await api.topics.markUnread(req, {
    ...req.params
  });
  helpers.formatApiResponse(200, res);
};
Topics.bump = async (req, res) => {
  await api.topics.bump(req, {
    ...req.params
  });
  helpers.formatApiResponse(200, res);
};
