...
async function sanitizeSvg(filePath) {
  ...
  const clean = sanitizeHtml(dirty, {
    allowedTags: ['svg', 'g', 'defs', 'linearGradient', 'radialGradient', 'stop', 'circle', 'ellipse', 'polygon', 'polyline', 'path', 'rect', 'line', 'text', 'tspan', 'use', 'symbol', 'clipPath', 'mask', 'pattern', 'filter', 'feGaussianBlur', 'feOffset', 'feBlend', 'feColorMatrix', 'feMerge', 'feMergeNode'],
    allowedAttributes: {
      '*': ['x', 'y', 'x1', 'x2', 'y1', 'y2', 'cx', 'cy', 'r', 'rx', 'ry', 'width', 'height', 'd', 'points', 'viewBox', 'transform', 'fill', 'stroke', 'stroke-width', 'opacity', 'stop-color', 'stop-opacity', 'offset', 'style', 'class', 'text-anchor', 'font-size', 'font-family', 'id', 'clip-path', 'mask', 'filter', 'gradientUnits', 'gradientTransform', 'xmlns', 'preserveAspectRatio']
    },
    parser: {
      lowerCaseTags: false,
