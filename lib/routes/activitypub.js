...
module.exports = function (app, middleware, controllers) {
  helpers.setupPageRoute(app, '/world', [middleware.activitypub.enabled, middleware.activitypub.pageview], controllers.activitypub.topics.list);
  helpers.setupPageRoute(app, '/ap', [middleware.activitypub.enabled, middleware.activitypub.pageview], controllers.activitypub.fetch);
  const middlewares = [middleware.activitypub.enabled, middleware.activitypub.pageview, middleware.activitypub.assertS2S, middleware.activitypub.verify, middleware.activitypub.configureResponse];
  const inboxMiddlewares = [middleware.activitypub.assertPayload, middleware.activitypub.resolveObjects, middleware.activitypub.normalize];
