...
module.exports = function () {
  ...
  setupApiRoute(router, 'delete', '/:tid/ignore', [...middlewares, middleware.assert.topic], controllers.write.topics.unfollow);
  ...
  setupApiRoute(router, 'post', '/:tid/thumbs', [middleware.validateFiles, middleware.uploads.ratelimit, ...middlewares], controllers.write.topics.addThumb);
